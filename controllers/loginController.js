...
async function loginUserWithTwitter(req, res) {
  ...
  // if not redirect from twitter, go to twitter login first
    ...
    const response = await fetch(
      "https://twitter.com/oauth/request_token?oauth_consumer_key=D8ALg4MyQluL8bZLoh1MAeU4b&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1655488547&oauth_nonce=dR8xrS&oauth_version=1.0A&oauth_callback=http%253A%252F%252Flocalhost%253A4000%252Flogin%252Ftwitter&oauth_signature=l3tcoOxMLRXMvgogxLFClea%2Fik8%3D&oauth_consumer_key=D8ALg4MyQluL8bZLoh1MAeU4b&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1655681856&oauth_nonce=dR8xrS&oauth_version=1.0A&oauth_callback=http%253A%252F%252Flocalhost%253A4000%252Flogin%252Ftwitter&oauth_signature=%2BdDu7veF57mu5G5HgQGJ%2BqXVr7k%3D&oauth_consumer_key=D8ALg4MyQluL8bZLoh1MAeU4b&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1655702385&oauth_nonce=dR8xrS&oauth_version=1.0A&oauth_callback=http%253A%252F%252Flocalhost%253A4000%252Flogin%252Ftwitter&oauth_signature=Ow8lkGMYplpi1DYEbV2Nv%2BKuc5c%3D&oauth_consumer_key=D8ALg4MyQluL8bZLoh1MAeU4b&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1655734785&oauth_nonce=dR8xrS&oauth_version=1.0A&oauth_callback=http%253A%252F%252Flocalhost%253A4000%252Flogin%252Ftwitter&oauth_signature=u5eAHaPlVYFnnA9gWztzRUHwz0k%3D"
    );
